...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{n\PYZus{}colors} \PY{o}{=} \PY{l+m+mi}{32}
        \PY{n}{pic} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{https://www.dropbox.com/s/bmwwfct2qxjfje4/sutd.png?dl=1}\PY{l+s+s1}{\PYZsq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{w}\PY{p}{,} \PY{n}{h}\PY{p}{,} \PY{n}{d} \PY{o}{=} \PY{n+nb}{tuple}\PY{p}{(}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
         \PY{n}{image\PYZus{}array} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{p}{(}\PY{n}{w} \PY{o}{*} \PY{n}{h}\PY{p}{,} \PY{n}{d}\PY{p}{)}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} print(image\PYZus{}array)}
         \PY{c+c1}{\PYZsh{} print(type(image\PYZus{}array))}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{recreate\PYZus{}image}\PY{p}{(}\PY{n}{palette}\PY{p}{,} \PY{n}{labels}\PY{p}{,} \PY{n}{w}\PY{p}{,} \PY{n}{h}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Question 2  (a)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{my\PYZus{}sample} \PY{o}{=} \PY{n}{image\PYZus{}array}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{1000}\PY{p}{)}\PY{p}{,} \PY{p}{:}\PY{p}{]}
         \PY{c+c1}{\PYZsh{} print(my\PYZus{}sample.shape)}
         \PY{n}{kmeanmodel} \PY{o}{=} \PY{n}{KMeans}\PY{p}{(}\PY{n}{n\PYZus{}clusters}\PY{o}{=}\PY{l+m+mi}{32}\PY{p}{)}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{my\PYZus{}sample}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} print(kmeanmodel)}
         \PY{n}{kmeans\PYZus{}palette} \PY{o}{=} \PY{n}{kmeanmodel}\PY{o}{.}\PY{n}{cluster\PYZus{}centers\PYZus{}}
         \PY{n}{kmeans\PYZus{}labels} \PY{o}{=} \PY{n}{kmeanmodel}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} print(kmeans\PYZus{}palette.shape)}
         \PY{c+c1}{\PYZsh{} print(kmeans\PYZus{}labels.shape)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Question 2  (b)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{n}{random\PYZus{}palette} \PY{o}{=} \PY{n}{image\PYZus{}array}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{32}\PY{p}{)}\PY{p}{,} \PY{p}{:}\PY{p}{]}
         \PY{n}{random\PYZus{}labels} \PY{o}{=} \PY{n}{pairwise\PYZus{}distances\PYZus{}argmin}\PY{p}{(}\PY{n}{image\PYZus{}array}\PY{p}{,} \PY{n}{random\PYZus{}palette}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} print(random\PYZus{}labels.shape)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
